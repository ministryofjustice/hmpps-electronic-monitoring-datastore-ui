...
import { OrderSearchFirstName, OrderSearchLastName, OrderSearchAlias } from '../../models/requests/OrderSearchRequest'

describe('NameValidator Class', () => {
  describe('OrderSearchFirstName', () => {
    it('should allow valid first names', () => {
      const validName = 'Alice'
      const result = OrderSearchFirstName.safeParse(validName)
    ...
    it('should accept an empty first name as optional', () => {
      const emptyName = ''
      const result = OrderSearchFirstName.safeParse(emptyName)
      expect(result.success).toBeTruthy()
    })
  })

  describe('OrderSearchLastName', () => {
    it('should allow valid last names', () => {
      const validName = 'Smith'
      const result = OrderSearchLastName.safeParse(validName)
      expect(result.success).toBeTruthy()
      expect(result.data).toBe(validName)
    })
    ...
    it('should accept an empty last name as optional', () => {
      const emptyName = ''
      const result = OrderSearchLastName.safeParse(emptyName)
      expect(result.success).toBeTruthy()
    })
  })

  describe('OrderSearchAlias', () => {
    it('should allow valid aliases', () => {
      const validAlias = 'Nickname'
      const result = OrderSearchAlias.safeParse(validAlias)
      expect(result.success).toBeTruthy()
    ...
    it('should accept an empty alias as optional', () => {
      const emptyAlias = ''
      const result = OrderSearchAlias.safeParse(emptyAlias)
      expect(result.success).toBeTruthy()
    })
  })
})
